find_path(FFTW3_INCLUDES fftw3.h HINTS ${PARAFAFT_FFTW_DIR}/include)
mark_as_advanced(FFTW3_INCLUDES)

# Find the FFTW libraries
find_library(FFTW3_LIB fftw3 HINTS ${PARAFAFT_FFTW_DIR}/lib)
...
find_library(FFTW3_THREADS_LIB fftw3_threads HINTS ${PARAFAFT_FFTW_DIR}/lib)
mark_as_advanced(FFTW3_THREADS_LIB)

find_library(FFTW3_OMP_LIB fftw3_omp HINTS ${PARAFAFT_FFTW_DIR}/lib)
mark_as_advanced(FFTW3_OMP_LIB)

# If float support is enabled, find the single-precision FFTW libraries.
if(Float)
  find_library(FFTW3F_LIB fftw3f HINTS ${PARAFAFT_FFTW_DIR}/lib)
  mark_as_advanced(FFTW3F_LIB)
  # Also find threaded versions if available
  find_library(FFTW3F_THREADS_LIB fftw3f_threads HINTS ${PARAFAFT_FFTW_DIR}/lib)
  mark_as_advanced(FFTW3F_THREADS_LIB)
  find_library(FFTW3F_OMP_LIB fftw3f_omp HINTS ${PARAFAFT_FFTW_DIR}/lib)

...
namespace parafaft
{
  ...
  //   using Buffer = ...;           // Buffer type (e.g., std::vector<double>)
  //   using ComplexBuffer = ...;    // Buffer type (e.g., std::vector<Complex>)
  //
  ...
  //    ~Backend()
  //
  // 5. Memory copy method, can be dependent on hardware:
  ...
  //
  // 6. R2C plan creation (forward: real → complex):
  ...
  //
  // 8. C2R plan creation (backward: complex → real):

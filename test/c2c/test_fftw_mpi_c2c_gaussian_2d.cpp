...
int compare_fftwBackend(const int N, int rank)
{
  if (rank == 0) {
    std::cout << "\n==========================================" << std::endl;
    std::cout << "Testing parafaft FFTWBackend for 2D C2C transform of size " << N << "x" << N << std::endl;
  }
  ...
  parafaft::ParaFaFT<2, parafaft::FFTWBackend> fft(global_shape);
...
int main(int argc, char **argv)
{
  ...
  if (rank == 0) {
    std::cout << "########################################" << std::endl;
    std::cout << "# TEST: c2c/fftw_mpi_c2c_gaussian_2d" << std::endl;
    std::cout << "########################################" << std::endl;
  }

...
int main(int argc, char **argv)
{
  ...
  if (rank == 0) {
    std::cout << "########################################" << std::endl;
    std::cout << "# TEST: r2c/fftw_mpi_r2c_roundtrip" << std::endl;
    std::cout << "########################################" << std::endl;
  }
  ...
  if (rank == 0) {
    std::cout << "R2C Roundtrip Test: " << N0 << "x" << N1 << "x" << N2 << " with " << size << " processes\n";
  }
  ...
  if (rank == 0) {
    ...
    std::cout << "================================\n";
    std::cout << "SUMMARY: r2c/fftw_mpi_r2c_roundtrip\n";
